...
export default function HomePage() {
  ...
  const handleOpenMusic = () => {
    // Sekarang .play() akan berhasil karena audioRef sudah ada
  ...
  return (
    <>
      {/* === INI PERBAIKANNYA === */}
      {/* 1. Audio player & Tombol Mute dipindah ke sini (level teratas) */}
